	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				try {
				EmpleadoBase e = new EmpleadoBase(dni,nombre,tipo);
			...
			case 2:
				...
				try {
					JefeDepartamento j = new JefeDepartamento(dniJ, nombreJ, antJ, sJ);
				...
				break;
			case 3:
				System.out.println("El total del sueldo es " + d.obtenerSueldo() + " euros.");
				break;
			case 4:
